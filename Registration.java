...
/** Test 2**/
        ...
        System.out.printf("%nExpected output: Colin Allcars, student number: 223 was born on 1974-04-12 and is 44 years old");
        System.out.printf("%nActual output:   %s was born on %s and is %d years old", st1, st1.getBirthday(), st1.getAge());
        if (st1.getBirthday().equals(LocalDate.of(1974, Month.APRIL, 12)) && st1.getAge() == 44) {
            marks++;
...
/**Test 9  **/           
        ...
        Instructor ellaV = new Instructor("Ella", "Vader", 1000012, "10 Hightop Lane", "Barrie", "L2S 1A6", LocalDate.of(2013, Month.AUGUST, 22), LocalDate.of(1965, Month.JUNE, 6));
...
/**Test  10 **/           
        ...
        System.out.printf("%nExpected output: Ella Vader is 53 years old.");
        System.out.printf("%nActual output:   %s is %d years old.", ellaV, ellaV.getAgeInYears());
        if (ellaV.getAgeInYears() == 53) {
            marks++;
        } else {
